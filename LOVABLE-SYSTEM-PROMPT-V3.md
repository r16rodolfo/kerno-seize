# Prompts de Chat para Lovable.dev — Kerno Seize v6.1.0

> **Versão:** 3.3 (Kerno Seize v6.1.0)
...
Este projeto usa o framework Kerno Seize v6.1.0 com planejamento feito pelo BMAD Method.
...
### Fluxo completo no Lovable (Kerno Seize v6.1.0)
