# Prompts de Chat para Lovable.dev — Kerno Seize v6.2.1

> **Versão:** 3.3 (Kerno Seize v6.2.1)
...
Este projeto usa o framework Kerno Seize v6.2.1 com planejamento feito pelo BMAD Method.
...
### Fluxo completo no Lovable (Kerno Seize v6.2.1)
