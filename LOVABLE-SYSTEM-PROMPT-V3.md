# Prompts de Chat para Lovable.dev — Kerno Seize v6.0.4

> **Versão:** 3.3 (Kerno Seize v6.0.4)
...
Este projeto usa o framework Kerno Seize v6.0.4 com planejamento feito pelo BMAD Method.
...
### Fluxo completo no Lovable (Kerno Seize v6.0.4)
